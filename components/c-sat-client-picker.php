    ...
    <div class="c-sat-client-picker__inner">
        <div class="c-sat-client-picker__container o-container">
            <div class="c-sat-client-picker__col o-col-8@md o-col-push-2@md o-col-8@sm o-col-4@xs">
                ...
                <button type="button" class="c-sat-client-picker__toggle-new js-sat-client-picker__toggle-new">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                    <span>¿No existe? Crear cliente nuevo</span>
                </button>

                <div class="c-sat-client-picker__new-client js-sat-client-picker__new-client is-hidden">
                    <?php
                        $name        = '';
                        $dni         = '';
                        $phone       = '';
                        $email       = '';
                        $redirect_to = $crear_sat_url;
