    ...
    <div class="c-client-form__inner-form">        
        <div class="c-client-form__wrapper-form-form">
            <form class="c-client-form__form-form" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="POST">
                ...
                <select class="c-client-form__type-client js-client-form__type-client" name="type-client" id="type-client">
                    <option value="particular" <?php selected($type_client, 'particular'); ?>>Particular</option>
                    <option value="profesional" <?php selected($type_client, 'profesional'); ?>>Profesional</option>                                                    
                </select>
                <div class="c-client-form__wrapper-box">
                    <div class="c-client-form__wrapper-form-input">                    
                        <label>Nombre y apellido / Nombre de empresa*</label>
                    ...
                    <div class="c-client-form__wrapper-form-input">
                        <label>EMAIL</label>
                        <input class="c-client-form__input c-client-form__input-email js-check-user" data-id="email" type="text" name="email" value="<?= $email ?? '' ?>">
                    </div> 
                </div>
                <div class="c-client-form__wrapper-box">
                    <div class="c-client-form__wrapper-form-input">
                ...
                <div class="c-client-form__wrapper-actions">
